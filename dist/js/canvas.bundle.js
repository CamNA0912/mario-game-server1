...
function animate() {
  ...
  } else if (keys.left.pressed && player.position.x > 100 || keys.left.pressed && scroll0ffset === 0 && player.position.x > 0) {
    player.velocity.x = -player.speed;
  } else {
    player.velocity.x = 0;
  ...
  console.log(scroll0ffset); // platform collision detection
